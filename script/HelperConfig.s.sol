...
contract HelperConfig is Script {
    ...
    function getEthMainnetConfig() public pure returns(NetworkConfig memory) {
        NetworkConfig memory netConfig = NetworkConfig({
            entryPoint : 0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789,    // EntryPoint Contract Address for Ethereum Mainnet
    ...
    function getOrCreateAnvilNetConfig() public returns(NetworkConfig memory) {
        ...
        NetworkConfig memory netConfig = NetworkConfig({
            entryPoint : address(_entryPointContract),
            account: vm.envAddress("ANVIL_1ST_TEST_ADDRESS")
        });
